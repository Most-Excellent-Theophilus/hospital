...
type DropzoneProps<TUploadRes, TUploadError>
  = UseDropzoneReturn<TUploadRes, TUploadError>& {
...
type DropzoneFileListItemProps<TUploadRes, TUploadError>
