...
const PatientsviewModule = () => {
  ...
  return <div>
    ...
    {selectedPatients?.map((patient, i) => <div className="flex relative"> <div className=" absolute -left-4 "><Badge className="text-base sm:mt-6 font-bold">{i + 1}</Badge></div> <PatientViewer data={patient as unknown as PatientSchema} deletee /></div>)}
