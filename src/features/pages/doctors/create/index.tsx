...
import { DoctorFormValues, registrationSchema } from "@/features/pages/doctors/users.types";
import { checkUserEmail, updateDoctor } from "@/features/pages/doctors/users.actions";
...
export default function CreateAccountPage({ data, }: { data?: UserSchema | null,  }) {
